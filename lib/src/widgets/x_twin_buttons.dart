        ...
        children: [
          Expanded(
            child: XTextButton(
              ...
              textColor: confirmTextColor ?? context.onPrimaryColor,
          ...
          Expanded(
            child: XTextButton(
              ...
              borderColor: cancelBorderColor ?? context.onPrimaryContainerColor.withOpacity(0.7),
              height: buttonsHeight ?? 35,
              onTap: cancelAction ?? () => Navigator.pop(context),
              text: cancelText ?? 'انصراف',
              textStyle: context.bodyLarge,
              textColor: cancelTextColor ?? context.onPrimaryContainerColor.withOpacity(0.7),
            ),
          ),
        ],
      ),
