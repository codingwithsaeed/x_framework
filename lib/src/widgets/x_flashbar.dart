...
abstract class XFlashbar {
  ...
  static void show({
    ...
    Flushbar(
      ...
      backgroundColor: backgroundColor ?? context.scheme.primaryContainer,
      messageColor: textColor ?? context.scheme.onSurface,
      flushbarPosition: FlushbarPosition.TOP,
      textDirection: Directionality.of(context),
      borderRadius: BorderRadius.circular(XDimens.sPadding),
      borderColor: hideBorder ? null : context.scheme.outline,
      duration: duration,
