...
abstract class XSheets {
      ...
      actions: Row(
        children: [
          ...
          XTextButton(
            ...
            borderColor: context.isLight ? context.scheme.primaryContainer.withOpacity(0.7) : context.scheme.onSurface,
            onTap: () => context.pop(),
            text: cancelText ?? 'خیر',
            textColor: context.isLight ? context.scheme.primaryContainer.withOpacity(0.7) : context.scheme.onSurface,
          ).expand(),
        ],
      ),
  ...
  static Future<T?> showSheet<T>(
    ...
    return await showModalBottomSheet<T>(
      ...
      context: context,
      builder: (context) {
        var titleColored = titleColor ?? (context.isLight ? context.scheme.primary : context.scheme.primaryContainer);
                            ...
                            if (hasCancelButton) ...[
                              ...
                              XTextButton(
                                ...
                                borderColor: context.isLight
                                    ? context.scheme.primaryContainer.withOpacity(0.7)
